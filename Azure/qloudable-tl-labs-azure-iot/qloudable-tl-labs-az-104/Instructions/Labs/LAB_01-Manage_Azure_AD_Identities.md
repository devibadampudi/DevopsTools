...
[Create and configure Azure AD users](#create-and-configure-azure-ad-users)

[Create Azure AD groups with assigned and dynamic membership](#create-azure-ad-groups-with-assigned-and-dynamic-membership)

[Create an Azure Active Directory tenant](#create-an-azure-active-directory-tenant)

[Manage Azure AD guest users](#manage-azure-ad-guest-users)

[Clean up resources](#clean-up-resources)

## Overview

The aim of this lab to allow Contoso users to authenticate by using Azure AD, you have been tasked with provisioning users and group accounts. Membership of the groups should be updated automatically based on the user job titles. You also need to create a test Azure AD tenant with a test user account and grant that account limited permissions to resources in the Contoso Azure subscription.
...
2. Create Azure AD groups with assigned and dynamic membership

3. Create an Azure Active Directory (AD) tenant

4. Manage Azure AD guest users 
...
**Conclusion:** Congratulations! You have successfully completed the lab **Manage Azure Active Directory Identities**!.Feel free to continue exploring or start a new lab.
