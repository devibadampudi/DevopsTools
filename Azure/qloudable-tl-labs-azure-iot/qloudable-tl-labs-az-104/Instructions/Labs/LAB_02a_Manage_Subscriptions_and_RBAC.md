...
[Implement Management Groups](#implement-management-groups)

[Create custom RBAC roles](#create-custom-RBAC-roles)
...
The main Aim of this lab is creating a management group that would include all of Contoso's Azure subscriptions.

**Scenario & Objectives**

In order to improve management of Azure resources in Contoso, you have been tasked with implementing the following functionality:

1. creating a management group that would include all of Contoso's Azure subscriptions

2. granting permissions to submit support requests for all subscriptions in the management group to a designated Azure Active Directory user. That user's permissions should be limited only to: 
...
Congratulations! You have successfully completed the lab **Manage Subscriptions and RBAC**!.Feel free to continue exploring or start a new lab.
